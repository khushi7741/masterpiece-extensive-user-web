    ...
    <div className="relative mb-2 w-full">
        ...
        <div className="absolute text-white h-full top-0 flex flex-col justify-center items-center w-full">
          <div className="flex flex-col gap-10 w-full justify-center items-center">
            <h1 className="xl:text-7xl lg:text-5xl md:text-2xl text-xl font-bold font-Mazaeni w-1/2 text-center">
              promoting custom fashion,for your perfect fits!
            </h1>
            <div className="relative lg:w-2/5 w-4/5">
              <input
                type="search"
              ...
              />
              <IconSearch className="absolute w-6 h-6 text-brown lg:top-4 top-2 left-3" />
              <button className="absolute md:px-6 px-2 lg:py-2 rounded-md bg-brown right-3 top-2">
                search
              </button>
            </div>
            <div className="flex md:flex-row flex-col md:gap-5 gap-2 text-sm items-center">
              ...
              <Link
                to=""
                className="px-4 py-2 border bg-brown/20 rounded-3xl border-F6F2EC/30"
              >
                lehenga
              </Link>
              <Link
